...
namespace Blog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWork unitOfWork,IImageHelper ımageHelper,IHttpContextAccessor httpContextAccessor, IMapper mapper,SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
        ...
        public async Task<bool> UserProfileUpdateAsync(UserProfileDto userProfileDto)
        {
            ...
            if (isVerified && userProfileDto.NewPassword != null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (userProfileDto.Photo!=null) { user.ImageId = await UploadImageForUser(userProfileDto);  }
