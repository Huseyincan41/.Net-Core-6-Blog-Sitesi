...
namespace Blog.Service.Services.Concrete
{
    public class ArticleService : IArticleService
    {
        ...
        public async Task<ArticleListDto> GetAllByPagingAsync(Guid? categoryId,int currentPage=1,int pageSize=3,bool isAscending=false)
        {
            ...
            var articles = categoryId == null ? await unitOfWork.GetRepository<Article>().GetAllAsync(a => !a.IsDeleted, a => a.Category, i => i.Image,u=>u.User)
        ...
        public async Task<ArticleDto> GetArticlesWithCategoryNonDeletedAsync(Guid articleId)
        {
            ...
            var article = await unitOfWork.GetRepository<Article>().GetAsync(x => !x.IsDeleted && x.Id==articleId, x => x.Category,includeProperties=>includeProperties.Image,u=>u.User);
        ...
        public async Task<string> SafeDeleteArticleAysnc(Guid articleId)
        {
            var userEmail=_user.GetLoggedInEmail() ;
        ...
        public async Task<string> UndoDeleteArticleAysnc(Guid articleId)
        {
